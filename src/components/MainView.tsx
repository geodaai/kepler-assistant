...
export function MainView() {
  ...
  return (
    <div className="flex h-full flex-col bg-background text-foreground p-3 text-xs">
      {/* Chat.Root provides the SessionChatRuntimeProvider + SessionChatManager +
      ToolRenderBehaviorProvider that the chat UI needs. Using the public
      compound component (rather than deep `require`s of @sqlrooms/ai-core
      internals) keeps these imports statically resolvable by every bundler. */}
      <Chat.Root>
        <AutoSessionTitle />
