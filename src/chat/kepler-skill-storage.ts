/**
 * In-memory `SkillStorage` for the AI chat harness. Keeps two roots:
 *
 * - `built-in`: read-only, seeded from the `seeds` passed to the constructor.
 ...
 *
 * This class is kepler-agnostic: the host app (e.g. kepler.gl's demo-app)
 * passes seed skills to the constructor. The kepler-flavored default bundle
 * ships as `SEED_SKILLS` (see `seedSkills.ts`, generated from
 * `skills/built-in/` by `scripts/generate-skills.mjs`); hosts override it by
 * passing their own seeds.
 */
